...
class JoinOrderBenchmark(object):
    ...
    CATEGORICAL_COLUMNS = collections.defaultdict(
        list,
        {
            ...
            'company_type': ['kind'],
            # 2
            # temporarily added company_id for UAE
            ...
            # 11
            # temporarily added person_id for UAE
...
def LoadImdb(table=None,
    ...
    """
    assert use_cols in ['toy','simple', 'content', 'multi','imdb-db','imdb-full-dup','union','deepdb','imdb-full-deepdb', 'job','uae-light',None], use_cols
