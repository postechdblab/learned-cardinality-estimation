...
class Parameters():
    def __init__(self, condition_max_num, indexes_id, tables_id, columns_id, physic_ops_id, column_total_num,
                 ...
                 bool_ops_total_num, compare_ops_total_num, data, min_max_column, wordvectors_path, cost_label_min,
                 cost_label_max, card_label_min, card_label_max, hid1, hid2, batch, lr, is_imdb=True):
        ...
        self.wordvectors_path = wordvectors_path
        self.wordvectors = wordvectors_path
