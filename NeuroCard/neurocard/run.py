...
class NeuroCard(tune.Trainable):
    ...
    def _simple_save(self):
        ...
        # PATH = f'{MODEL_PATH}/{workload}_{self.epochs}_{self.fc_hiddens}_{self.embed_size}_{self.word_size_bits}_{self.layers}.tar'
        # print('Saved to:', PATH)
        # # wandb.save(PATH)
    ...
    def _save(self, tmp_checkpoint_dir):
        ...
        rep_path = f"../../models/NeuroCard/{self.workload_name}.tar"
        ...
        if self.mode == "TRAIN":
            ...
            os.makedirs(f"../../models/NeuroCard/",exist_ok=True)
            try:
